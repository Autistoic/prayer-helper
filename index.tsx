...
const INITIAL_FAJR_PRAYER_PHRASES: PrayerPhrase[] = [
  ...
  },
  {
    ...
    "phonetics_spanish": "Bis-mil-lá-jir Raj-má-nir Ra-jím",
  ...
  },
  {
    ...
    "phonetics_spanish": "Al-jám-du lil-lá-hi ráb-bil aa-la-mín",
...
const App: React.FC = () => {
  ...
  }, [currentTime, prayerPhrases, isPlaying]);
      ...
      {prayerPhrases.map((phrase, index) => (
        <div key={phrase.id} className={`card ${activePhraseId === phrase.id ? 'active' : ''}`}>
          ...
          <div className="phrase-body">
            <div className="phrase-arabic-container">
              <div>
                <div className="label">Árabe</div>
              </div>
              <div className="arabic-and-image-wrapper">
                ...
                {phrase.position_image_names?.length > 0 && (
                  <div className="position-images">
                    {phrase.position_image_names.map((name, idx) => (
                       <div key={idx} className="position-image-container">
                        <img 
                          src={imageUrls[name]} 
            ...
            <div className="phrase-details-grid">
              <div className="detail-item">
                <div className="label">Transliteración</div>
                <div>{phrase.transliteration}</div>
              </div>
              <div className="detail-item">
                <div className="label">Fonética (Español)</div>
                <div>{phrase.phonetics_spanish}</div>
              </div>
              <div className="detail-item">
                <div className="label">Traducción</div>
